...
export default function Method({ hideHeading = false } = {}) {
  const principles = [
    ...
    },
    {
      ...
      body: 'Τακτική επαφή με τους γονείς, με ενημερώσεις μετά από κάθε διαγώνισμα προσομοίωσης και προγραμματισμένες συναντήσεις στους κομβικούς σταθμούς της χρονιάς. Όχι μόνο για βαθμούς — για το πραγματικό πρόσωπο της προετοιμασίας.'
    }
  ];
