// Hairline SVG icons (1.5px stroke, currentColor)
  ...
  return (
    <section id="extras">
      <div className="container">
        <SectionHead
          eyebrow="Επιπλέον"
          title={<React.Fragment>Όλα όσα μπορεί να<br />χρειαστεί ένας <span style={{ fontStyle: "italic" }}>μαθητής.</span></React.Fragment>}
        />
        ...
        <div style={{ borderTop: "1px solid var(--rule)" }}>
          <ExtraRow
            ...
            body="Εντατικά τμήματα τους θερινούς μήνες για όσους θέλουν να μπουν στη χρονιά με πλεονέκτημα."
          />
          <ExtraRow
            icon={<IconDiamond />}
            title="Ιδιαίτερα μαθήματα"
            body="Παραδίδονται και ιδιαίτερα σε όλα τα μαθήματα, για στοχευμένη υποστήριξη όπου χρειάζεται."
          />
        </div>
      </div>
    </section>
