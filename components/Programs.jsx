function ProgramCard({ field, num, kind, body, tag }) {
  // Distinguished card (first) gets a top ink-900 rule + small tag, instead of the regular rule.
  const isFeature = !!tag;
  return (
...
function Programs({ hideHeading = false } = {}) {
  const programs = [
    {
      num: "2",
      field: "Θετικών Σπουδών",
      kind: "Επιστημονικό πεδίο",
      body: "Μαθηματικά, Φυσική, Χημεία. Το πεδίο που ορίζει την ταυτότητα του φροντιστηρίου εδώ και δεκαετίες.",
      tag: true
    },
    {
      num: "3",
      ...
      kind: "Επιστημονικό πεδίο",
      body: "Βιολογία, Χημεία, Φυσική. Στοχευμένη προετοιμασία για τις απαιτητικές σχολές υγείας."
    },
    {
      num: "4",
      field: "Σπουδών Οικονομίας & Πληροφορικής",
      kind: "Επιστημονικό πεδίο",
      body: "Μαθηματικά, ΑΟΘ, Πληροφορική. Για όσους κοιτούν οικονομικές, διοίκησης και τεχνολογικές σχολές."
    }
  ];
